  ...
  useEffect(() => {
    const loadLabs = async () => {
      try {
        ...
        const res = await axios.get("https://bloodbank-backend-99hc.onrender.com/api/facility/labs", {
  ...
  const submitRequest = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://bloodbank-backend-99hc.onrender.com/api/hospital/blood/request",
        form,
        { headers: { Authorization: `Bearer ${token}` } }
      );
